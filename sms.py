...
def predict_spam():
    ...
    if prediction[0] == 1:
        messagebox.showinfo("Spam Detection Result", "❌ This email is spam!", icon="error")
    else:
        messagebox.showinfo("Spam Detection Result", "✅ This email is not spam!", icon="info")
...
label = ttk.Label(frame, text="Enter email text:")
label.pack(pady=(10, 5))
text_entry = ttk.Entry(frame, width=50)
text_entry.pack(pady=(0, 10))

predict_button = ttk.Button(frame, text="Check Spam", command=predict_spam)
predict_button.pack()
